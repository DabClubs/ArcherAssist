...
using ArcherAssist.Models;
using ArcherAssist.Responses.Cancel;
using ArcherAssist.Responses.Main;
using ArcherAssist.Services;

namespace ArcherAssist.Dialogs
{
